...
public class VI_DrawDiagonal {
    public static void main(String[] args) {
        ...
        for (int MiddleRows = 0; MiddleRows < squareSides - 2; MiddleRows++) //Middle rows
        {
            System.out.print("%");
        ...
        for (int lastRow = 0; lastRow < squareSides; lastRow++)  //The last row.
        {
            System.out.print("%");
        }
        System.out.println();
