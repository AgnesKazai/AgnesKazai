...
public class Monster extends Character {
    ...
    public static void addMonster(GameObject[][] gameMap) {
        ...
        for (int i = 0; i < rnd; i++) {
            ...
            if (i == 0) {
                ...
                listOfMonsters.get(i).setImages("boss.png");
            } else if (i == 1) {
                listOfMonsters.add(new Monster(rndMonsterPositionY * 72, rndMonsterPositionX * 72));
    ...
    public void moveMonster(GameObject[][] gameMap) {
